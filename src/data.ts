...
export const PROPOSAL_ITEMS: ProposalItem[] = [
  ...
  },
  {
    id: 'banner',
    category: '메인 비주얼',
    title: '2026년 최신 지표 반영 및 타이포그래피 강화',
    asIs: '단조로운 고딕 텍스트로 메인 카피의 매력이 떨어지고, 여전히 2024년 통계(임플란트 35,000건)에 머물러 있어 활성도가 낮아 보입니다.',
    toBe: '기존 사이트 메인 배너(의료진·임플란트 지표 등)를 풀블리드 자동 슬라이드로 재구성하고, 2026년 "임플란트 누적 35,000건 돌파" 지표와 세련된 타이포그래피를 하단에 배치해 첫 인상 신뢰도를 높입니다.',
    effect: '첫 인상 신뢰도 극대화, 병원의 전문성과 역사성 부각, 시각적 압도감으로 이탈율 감소.',
    impactColor: 'teal',
  },
  {
    id: 'floating',
